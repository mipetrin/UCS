Sample UCS Python Script that will allow you to perform different types of UCS Backup Operations and save to the local file system
...
```YAML
# python ucs_backup.py --platform real
```
